...
Browse filters (condition, price, player count, country). In-app messaging. Saved/favorite listings. Cart for multi-item checkout. Map-based terminal selector. **Add Latvian locale.**

### Week 4 — Trust + Notifications
Reviews system. Seller ratings. In-app notifications. Reservation timer (15 min lock). Cloudflare Turnstile. Onboarding checklist.
...
### Week 6 — Trust + Safety
Dispute system. Refund flow. Seller trust badges. Newsletter. Help center. Account settings + GDPR.

### Week 7 — Wanted + Social
Wanted listings. Seller offers on wanted. Public seller profiles. Social sharing.

### Week 8+ — Growth
Auctions. PWA. Achievements. Price suggestions. Advanced search. Multi-seller cart. Shipping tracking. Seller analytics. Estonian + Lithuanian locales.
