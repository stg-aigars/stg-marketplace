          ...
          {photos.length < 4 && (
            <>
              ...
              <button
                ...
                disabled={uploading}
                className="w-full rounded-lg border-2 border-dashed border-semantic-border-subtle py-4 text-sm text-semantic-text-muted sm:hover:border-semantic-brand sm:hover:text-semantic-brand transition-colors duration-250 ease-out-custom disabled:opacity-50"
              >
