    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-semantic-bg-secondary border-y border-semantic-border-subtle">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="mb-8 max-w-2xl">
          ...
          <h2 className="text-2xl sm:text-3xl font-semibold font-platform tracking-tight text-semantic-text-heading">
            {t('heading')}
          </h2>
        </div>
        ...
        >
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14">
            <div>
              <h3 className="text-xl sm:text-2xl font-semibold font-platform tracking-tight text-semantic-text-heading mb-4">
