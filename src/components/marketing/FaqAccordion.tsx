      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-[280px_1fr] gap-10 lg:gap-16">
          <div className="lg:sticky lg:top-24 lg:self-start">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold font-display tracking-tight text-semantic-text-heading">
              {t('heading')}
            </h2>
          </div>
                ...
                <div key={index}>
                  <h3>
                    <button
                      ...
                      className="flex items-center justify-between w-full py-5 text-left font-display text-lg sm:text-xl font-medium text-semantic-text-heading transition-colors duration-250 ease-out-custom sm:hover:text-semantic-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-semantic-border-focus focus-visible:ring-offset-2 rounded-sm"
                    >
                      <span>{item.q}</span>
                      <Plus
                        size={24}
