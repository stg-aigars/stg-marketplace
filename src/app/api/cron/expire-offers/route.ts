/**
 * Shelf offer expiry cron endpoint.
 * 1. Expire unanswered shelf offers past 7-day TTL
 * 2. Revert accepted shelf offers where seller didn't create listing within 3 days
 *
