...
export default function AccessibilityPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="prose prose-sm max-w-none text-semantic-text-secondary space-y-4">
        ...
        <p>
          ...
          (Directive (EU) 2019/882) has applied to e-commerce services since 28 June 2025,
          and this page is how we describe where we stand.
        </p>
        ...
        <p>
          ...
          technology you were using (if any). You can contact us in English, Latvian,
          Lithuanian, or Estonian; we&apos;ll reply in English if needed.
        </p>
      </div>
    </div>
  );
