  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="flex items-center gap-6 sm:gap-10 py-4 mb-8 border-y border-semantic-border-subtle text-sm text-semantic-text-muted">
        <div>
          <span className="block text-lg font-bold font-platform text-semantic-text-heading">{completedSales}</span>
          {completedSales === 1 ? 'Sale' : 'Sales'}
        </div>
        <div className="w-px h-8 bg-semantic-border-subtle" />
        <div>
          <span className="block text-lg font-bold font-platform text-semantic-text-heading">
        ...
        <div className="w-px h-8 bg-semantic-border-subtle" />
        <div>
          <span className="block text-lg font-bold font-platform text-semantic-text-heading">{activeListings.length}</span>
          Listed
        </div>
      </div>
