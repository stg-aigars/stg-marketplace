...
export function MobileBuyBar({ targetRef, listingId, priceCents, isReservedByMe }: MobileBuyBarProps) {
  ...
  return (
    <div
      className={`fixed bottom-0 inset-x-0 z-40 lg:hidden bg-semantic-bg-elevated border-t border-semantic-border-subtle shadow-lg pb-safe px-4 pt-3 transition-transform duration-250 ease-out-custom ${
