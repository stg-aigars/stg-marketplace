    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="prose prose-sm max-w-none text-semantic-text-secondary space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p>
            Payments go through Swedbank AS, a Latvian credit institution acting as our
            payment service provider. The technical platform is operated on Swedbank&apos;s
            behalf by EveryPay AS (registered in Estonia, reg. 12280690). Buyer funds are
            held in a marketplace account and released to the seller once delivery is
            confirmed and the dispute window has closed. We are not a payment institution
            ourselves and do not hold a payment services licence. Our role in the payment
            flow is that of a commercial agent acting for sellers, relying on the exemption
            in Article 3(b) of Directive (EU) 2015/2366 (PSD2). If that exemption turns out
            not to apply, we will move the flow to a licensed payment institution.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            Payments are processed through Swedbank AS. Orders are only created after
