...
// Shadows - subtle Nordic elevation
export const shadows = {
  none: 'none',
  xs: '0 1px 2px 0 rgba(46, 52, 64, 0.05)',
  sm: '0 1px 3px 0 rgba(46, 52, 64, 0.08)',      // Resting
  md: '0 4px 8px 0 rgba(46, 52, 64, 0.12)',      // Hover
  lg: '0 8px 16px 0 rgba(46, 52, 64, 0.16)',     // Dropdowns
  xl: '0 12px 24px 0 rgba(46, 52, 64, 0.20)',    // Modals
  focus: '0 0 0 3px rgba(136, 192, 208, 0.3)',    // Focus ring (frost.ice)
} as const;
