...
export const conditionGuide = {
  likeNew: {
    ...
    detail:
      'A copy that looks like it just came home from the shop. Components are pristine — cards crisp, tokens unscuffed, board flat. The box might have the faint wear of having been opened and closed, but nothing more.',
    sellerHint:
  ...
  veryGood: {
    ...
    detail:
      'Played a handful of times and well looked after. Cards may have light shuffle marks at the edges, but no visible bends or scratches. The box might show small dings at the corners. All components are present and in clear shape.',
    sellerHint:
  ...
  good: {
    ...
    detail:
      'A regularly played copy with honest signs of use. Cards may have edge wear or shuffle creases, the box shows visible wear at corners and edges, and the rulebook may be folded or marked. Everything is functional and complete.',
    sellerHint:
      'If wear is significant enough to affect play — bent cards, warped boards, taped boxes — this is no longer Good. Drop to Acceptable and call out what is wrong in the listing description.',
  },
  acceptable: {
    example: 'Well-loved copy. Box may be taped, some components show significant wear. Still fully playable.',
    detail:
      'A well-loved copy that is still fully playable, with all components present. The box may be taped, components may show significant wear, and the rulebook may be soft or torn — but everything needed to play is there. Photos and a description are required at this tier.',
    sellerHint:
      'Use this when wear is heavy but the copy is complete. If even one piece is missing or broken beyond use, this becomes For Parts.',
  },
  forParts: {
    example: 'Missing pieces or damaged beyond normal play. Useful for replacing lost components or crafts.',
    detail:
      'Incomplete, damaged, or otherwise not playable as-is. Sold for crafts, replacements, or as a starting point for a homebrew copy. Buyers should expect to use it for components rather than for play. Photos and a description are required at this tier.',
    sellerHint:
