...
const CSP_TEMPLATE = [
  ...
  "font-src 'self'",
  `connect-src 'self' ${SUPABASE_URL} https://*.everypay.co https://*.unisend.com https://*.sentry.io https://challenges.cloudflare.com https://basemaps.cartocdn.com https://*.basemaps.cartocdn.com https://*.posthog.com`,
