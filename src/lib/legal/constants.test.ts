...
describe('PSD2_TRANSITIONAL_SUNSET', () => {
  it('is still within its sunset window — transitional Art. 3(b) wording in Seller Agreement §3 must be replaced before this fails', () => {
    ...
    //      scoping, rewrite Seller Agreement §3 (Payment authorisation and flow) to
    //      describe the Option 1 architecture and delete this constant + test.
